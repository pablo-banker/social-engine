...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.exploreResponse"
                        }
                    }
                }
            }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.likeResult"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.trendingResponse"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "entities.Post": {
            ...
            "properties": {
                "author": {
                    "description": "Associations loaded via LoadAssociations. Author is exposed nested;\nLikes/Comments are loaded only to derive the counters below.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/entities.User"
                        }
                ...
                "likes": {
                    "description": "Transient view fields derived from the loaded associations.",
                    "type": "integer"
                },
                "updatedAt": {
                    "type": "string"
        ...
        "entities.User": {
            ...
            "properties": {
                ...
                "stats": {
                    "description": "Stats is a transient aggregate populated only for profile responses.",
                    "allOf": [
                        {
        ...
        "handlers.trendingResponse": {
            ...
            "properties": {
                ...
                "topics": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.TrendingTopic"
                    }
                }
            }
        },
